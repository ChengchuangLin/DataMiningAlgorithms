package com.lcc.algo.dm.patterns.itemset_array_integers_with_count;
...
public class Itemsets{
	...
	/* (non-Javadoc)
	 * @see com.lcc.algo.dm.patterns.itemset_array_integers_with_count.AbstractItemsets#printItemsets(int)
	 */
...
//						+ itemset.getRelativeSupportAsString(nbObject));
	...
	/* (non-Javadoc)
	 * @see com.lcc.algo.dm.patterns.itemset_array_integers_with_count.AbstractItemsets#addItemset(com.lcc.algo.dm.patterns.itemset_array_integers_with_count.Itemset, int)
	 */
	...
	/* (non-Javadoc)
	 * @see com.lcc.algo.dm.patterns.itemset_array_integers_with_count.AbstractItemsets#getLevels()
	 */
	...
	/* (non-Javadoc)
	 * @see com.lcc.algo.dm.patterns.itemset_array_integers_with_count.AbstractItemsets#getItemsetsCount()
	 */
	...
	/* (non-Javadoc)
	 * @see com.lcc.algo.dm.patterns.itemset_array_integers_with_count.AbstractItemsets#setName(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.lcc.algo.dm.patterns.itemset_array_integers_with_count.AbstractItemsets#decreaseItemsetCount()
	 */
