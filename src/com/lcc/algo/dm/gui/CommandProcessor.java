...
import com.lcc.algo.dm.algorithms.associationrules.Indirect.AlgoINDIRECT;
import com.lcc.algo.dm.algorithms.associationrules.MNRRules.AlgoMNRRules;
import com.lcc.algo.dm.algorithms.associationrules.TopKRules_and_TNR.Database;
import com.lcc.algo.dm.algorithms.associationrules.closedrules.AlgoClosedRules;
import com.lcc.algo.dm.algorithms.associationrules.fhsar.AlgoFHSAR;
...
import com.lcc.algo.dm.algorithms.clustering.text_clusterer.TextClusterAlgo;
import com.lcc.algo.dm.algorithms.frequentpatterns.MSApriori.AlgoMSApriori;
import com.lcc.algo.dm.algorithms.frequentpatterns.apriori.AlgoApriori;
import com.lcc.algo.dm.algorithms.frequentpatterns.aprioriTID.AlgoAprioriTID;
import com.lcc.algo.dm.algorithms.frequentpatterns.aprioriTIDClose.AlgoAprioriTIDClose;
import com.lcc.algo.dm.algorithms.frequentpatterns.apriori_HT.AlgoAprioriHT;
import com.lcc.algo.dm.algorithms.frequentpatterns.apriori_close.AlgoAprioriClose;
import com.lcc.algo.dm.algorithms.frequentpatterns.apriori_inverse.AlgoAprioriInverse;
import com.lcc.algo.dm.algorithms.frequentpatterns.apriori_rare.AlgoAprioriRare;
import com.lcc.algo.dm.algorithms.frequentpatterns.cfpgrowth.AlgoCFPGrowth;
import com.lcc.algo.dm.algorithms.frequentpatterns.charm.AlgoCharmMFI;
import com.lcc.algo.dm.algorithms.frequentpatterns.charm.AlgoCharm_Bitset;
import com.lcc.algo.dm.algorithms.frequentpatterns.charm.AlgoDCharm_Bitset;
import com.lcc.algo.dm.algorithms.frequentpatterns.cori.AlgoCORI;
import com.lcc.algo.dm.algorithms.frequentpatterns.dci_closed_optimized.AlgoDCI_Closed_Optimized;
import com.lcc.algo.dm.algorithms.frequentpatterns.defme.AlgoDefMe;
import com.lcc.algo.dm.algorithms.frequentpatterns.eclat.AlgoDEclat;
import com.lcc.algo.dm.algorithms.frequentpatterns.eclat.AlgoDEclat_Bitset;
import com.lcc.algo.dm.algorithms.frequentpatterns.eclat.AlgoEclat;
import com.lcc.algo.dm.algorithms.frequentpatterns.eclat.AlgoEclat_Bitset;
import com.lcc.algo.dm.algorithms.frequentpatterns.fin_prepost.FIN;
import com.lcc.algo.dm.algorithms.frequentpatterns.fin_prepost.PrePost;
import com.lcc.algo.dm.algorithms.frequentpatterns.fpgrowth.AlgoFPClose;
import com.lcc.algo.dm.algorithms.frequentpatterns.fpgrowth.AlgoFPGrowth;
import com.lcc.algo.dm.algorithms.frequentpatterns.fpgrowth.AlgoFPMax;
import com.lcc.algo.dm.algorithms.frequentpatterns.hmine.AlgoHMine;
import com.lcc.algo.dm.algorithms.frequentpatterns.hui_miner.AlgoFHM;
import com.lcc.algo.dm.algorithms.frequentpatterns.hui_miner.AlgoFHN;
import com.lcc.algo.dm.algorithms.frequentpatterns.hui_miner.AlgoHUIMiner;
import com.lcc.algo.dm.algorithms.frequentpatterns.lcm.AlgoLCM;
import com.lcc.algo.dm.algorithms.frequentpatterns.lcm.AlgoLCMFreq;
import com.lcc.algo.dm.algorithms.frequentpatterns.lcm.AlgoLCMMax;
import com.lcc.algo.dm.algorithms.frequentpatterns.lcm.Dataset;
import com.lcc.algo.dm.algorithms.frequentpatterns.pascal.AlgoPASCAL;
import com.lcc.algo.dm.algorithms.frequentpatterns.relim.AlgoRelim;
import com.lcc.algo.dm.algorithms.frequentpatterns.two_phase.AlgoHUINIVMine;
import com.lcc.algo.dm.algorithms.frequentpatterns.two_phase.AlgoTwoPhase;
import com.lcc.algo.dm.algorithms.frequentpatterns.uapriori.AlgoUApriori;
import com.lcc.algo.dm.algorithms.frequentpatterns.upgrowth_ihup.AlgoIHUP;
import com.lcc.algo.dm.algorithms.frequentpatterns.upgrowth_ihup.AlgoUPGrowth;
import com.lcc.algo.dm.algorithms.frequentpatterns.upgrowth_ihup.AlgoUPGrowthPlus;
import com.lcc.algo.dm.algorithms.frequentpatterns.vme.AlgoVME;
...
import com.lcc.algo.dm.algorithms.sequential_rules.cmdeogun.AlgoCMDeogun;
import com.lcc.algo.dm.algorithms.sequential_rules.cmrules.AlgoCMRules;
import com.lcc.algo.dm.algorithms.sequential_rules.rulegen.AlgoRuleGen;
import com.lcc.algo.dm.algorithms.sequential_rules.rulegrowth.AlgoERMiner;
import com.lcc.algo.dm.algorithms.sequential_rules.rulegrowth.AlgoRULEGROWTH;
import com.lcc.algo.dm.algorithms.sequential_rules.topseqrules_and_tns.AlgoTNS;
import com.lcc.algo.dm.algorithms.sequential_rules.topseqrules_and_tns.AlgoTopSeqRules;
import com.lcc.algo.dm.algorithms.sequential_rules.trulegrowth.AlgoTRuleGrowth;
import com.lcc.algo.dm.algorithms.sequential_rules.trulegrowth_with_strings.AlgoTRuleGrowth_withStrings;
...
import com.lcc.algo.dm.algorithms.sequentialpatterns.BIDE_and_prefixspan.AlgoFSGP;
import com.lcc.algo.dm.algorithms.sequentialpatterns.BIDE_and_prefixspan.AlgoMaxSP;
import com.lcc.algo.dm.algorithms.sequentialpatterns.BIDE_and_prefixspan.AlgoPrefixSpan;
import com.lcc.algo.dm.algorithms.sequentialpatterns.BIDE_and_prefixspan.AlgoTSP_nonClosed;
import com.lcc.algo.dm.algorithms.sequentialpatterns.BIDE_and_prefixspan_with_strings.AlgoPrefixSpan_with_Strings;
import com.lcc.algo.dm.algorithms.sequentialpatterns.clasp_AGP.AlgoCM_ClaSP;
import com.lcc.algo.dm.algorithms.sequentialpatterns.clasp_AGP.AlgoClaSP;
import com.lcc.algo.dm.algorithms.sequentialpatterns.clospan_AGP.AlgoCloSpan;
import com.lcc.algo.dm.algorithms.sequentialpatterns.fournier2008_seqdim.AlgoFournierViger08;
import com.lcc.algo.dm.algorithms.sequentialpatterns.fournier2008_seqdim.AlgoPrefixSpanMDSPM;
...
import com.lcc.algo.dm.algorithms.sequentialpatterns.goKrimp.AlgoGoKrimp;
import com.lcc.algo.dm.algorithms.sequentialpatterns.goKrimp.DataReader;
import com.lcc.algo.dm.algorithms.sequentialpatterns.gsp_AGP.AlgoGSP;
import com.lcc.algo.dm.algorithms.sequentialpatterns.gsp_AGP.items.creators.AbstractionCreator;
import com.lcc.algo.dm.algorithms.sequentialpatterns.gsp_AGP.items.creators.AbstractionCreator_Qualitative;
import com.lcc.algo.dm.algorithms.sequentialpatterns.lapin.AlgoLAPIN_LCI;
import com.lcc.algo.dm.algorithms.sequentialpatterns.prefixSpan_AGP.AlgoPrefixSpan_AGP;
import com.lcc.algo.dm.algorithms.sequentialpatterns.spade_spam_AGP.AlgoCMSPADE;
...
import com.lcc.algo.dm.algorithms.sequentialpatterns.spade_spam_AGP.idLists.creators.IdListCreator_FatBitmap;
import com.lcc.algo.dm.algorithms.sequentialpatterns.spam.AlgoCMSPAM;
import com.lcc.algo.dm.algorithms.sequentialpatterns.spam.AlgoSPAM;
import com.lcc.algo.dm.algorithms.sequentialpatterns.spam.AlgoTKS;
import com.lcc.algo.dm.algorithms.sequentialpatterns.spam.AlgoVGEN;
import com.lcc.algo.dm.algorithms.sequentialpatterns.spam.AlgoVMSP;
import com.lcc.algo.dm.input.sequence_database_list_strings.SequenceDatabase;
...
import com.lcc.algo.dm.tools.dataset_generator.AddTimeStampsToSequenceDatabase;
...
import com.lcc.algo.dm.tools.dataset_generator.TransactionDatasetUtilityGenerator;
import com.lcc.algo.dm.tools.dataset_stats.SequenceStatsGenerator;
import com.lcc.algo.dm.tools.dataset_stats.TransactionStatsGenerator;
import com.lcc.algo.dm.tools.other_dataset_tools.FixTransactionDatabaseTool;
import com.lcc.algo.dm.tools.resultConverter.ResultConverter;
...
public class CommandProcessor {
	...
	public static void runAlgorithm(String algorithmName,
		...
		if ("PrefixSpan".equals(algorithmName)) {
			com.lcc.algo.dm.input.sequence_database_list_integers.SequenceDatabase sequenceDatabase = new com.lcc.algo.dm.input.sequence_database_list_integers.SequenceDatabase();
			...
			com.lcc.algo.dm.algorithms.sequentialpatterns.fournier2008_seqdim.SequenceDatabase database = new com.lcc.algo.dm.algorithms.sequentialpatterns.fournier2008_seqdim.SequenceDatabase();
		...
		//
			...
			// Apply algorithm
			com.lcc.algo.dm.algorithms.sequentialpatterns.fournier2008_seqdim.AlgoBIDEPlus bideplus = new com.lcc.algo.dm.algorithms.sequentialpatterns.fournier2008_seqdim.AlgoBIDEPlus(
					minsup);
			 ...
			 * algo.setMaximumPatternLength(getParamAsInteger(parameters[1])); }
			 */
			com.lcc.algo.dm.algorithms.sequentialpatterns.gsp_AGP.items.SequenceDatabase sd = new com.lcc.algo.dm.algorithms.sequentialpatterns.gsp_AGP.items.SequenceDatabase(
					abstractionCreator);
			...
			com.lcc.algo.dm.algorithms.sequentialpatterns.prefixSpan_AGP.items.creators.AbstractionCreator abstractionCreator = com.lcc.algo.dm.algorithms.sequentialpatterns.prefixSpan_AGP.items.creators.AbstractionCreator_Qualitative
					.getInstance();
			double minSupport = getParamAsDouble(parameters[0]);
			 ...
			 * algo.setMaximumPatternLength(getParamAsInteger(parameters[1])); }
			 */
			com.lcc.algo.dm.algorithms.sequentialpatterns.prefixSpan_AGP.items.SequenceDatabase sd = new com.lcc.algo.dm.algorithms.sequentialpatterns.prefixSpan_AGP.items.SequenceDatabase(
					abstractionCreator);
			sd.loadFile(inputFile, minSupport);
			...
			com.lcc.algo.dm.algorithms.sequentialpatterns.spade_spam_AGP.dataStructures.creators.AbstractionCreator abstractionCreator = com.lcc.algo.dm.algorithms.sequentialpatterns.spade_spam_AGP.dataStructures.creators.AbstractionCreator_Qualitative
					.getInstance();
			 ...
			 * algo.setMaximumPatternLength(getParamAsInteger(parameters[1])); }
			 */
			com.lcc.algo.dm.algorithms.sequentialpatterns.spade_spam_AGP.dataStructures.database.SequenceDatabase sd = new com.lcc.algo.dm.algorithms.sequentialpatterns.spade_spam_AGP.dataStructures.database.SequenceDatabase(
			...
			com.lcc.algo.dm.algorithms.sequentialpatterns.spade_spam_AGP.AlgoSPAM_AGP algo = new com.lcc.algo.dm.algorithms.sequentialpatterns.spade_spam_AGP.AlgoSPAM_AGP(
					minSupport);
			...
			com.lcc.algo.dm.algorithms.sequentialpatterns.clasp_AGP.dataStructures.creators.AbstractionCreator abstractionCreator = com.lcc.algo.dm.algorithms.sequentialpatterns.clasp_AGP.dataStructures.creators.AbstractionCreator_Qualitative
					.getInstance();
			com.lcc.algo.dm.algorithms.sequentialpatterns.clasp_AGP.idlists.creators.IdListCreator idListCreator = com.lcc.algo.dm.algorithms.sequentialpatterns.clasp_AGP.idlists.creators.IdListCreatorStandard_Map
					.getInstance();
			com.lcc.algo.dm.algorithms.sequentialpatterns.clasp_AGP.dataStructures.database.SequenceDatabase sd = new com.lcc.algo.dm.algorithms.sequentialpatterns.clasp_AGP.dataStructures.database.SequenceDatabase(
					abstractionCreator, idListCreator);
			...
			com.lcc.algo.dm.algorithms.sequentialpatterns.clospan_AGP.items.creators.AbstractionCreator abstractionCreator = com.lcc.algo.dm.algorithms.sequentialpatterns.clospan_AGP.items.creators.AbstractionCreator_Qualitative
					.getInstance();
			 ...
			 * algo.setMaximumPatternLength(getParamAsInteger(parameters[1])); }
			 */
			com.lcc.algo.dm.algorithms.sequentialpatterns.clospan_AGP.items.SequenceDatabase sd = new com.lcc.algo.dm.algorithms.sequentialpatterns.clospan_AGP.items.SequenceDatabase();
			sd.loadFile(inputFile, minSupport);
			...
			com.lcc.algo.dm.algorithms.sequentialpatterns.BIDE_and_prefixspan_with_strings.AlgoBIDEPlus_withStrings algo = new com.lcc.algo.dm.algorithms.sequentialpatterns.BIDE_and_prefixspan_with_strings.AlgoBIDEPlus_withStrings();
			algo.runAlgorithm(sequenceDatabase, outputFile, minsup);
			algo.printStatistics(sequenceDatabase.size());
			...
			com.lcc.algo.dm.input.sequence_database_array_integers.SequenceDatabase sequenceDatabase = new com.lcc.algo.dm.input.sequence_database_array_integers.SequenceDatabase();
			sequenceDatabase.loadFile(inputFile);
			...
			com.lcc.algo.dm.algorithms.associationrules.TopKRules_and_TNR.AlgoTopKRules algo = new com.lcc.algo.dm.algorithms.associationrules.TopKRules_and_TNR.AlgoTopKRules();
			algo.runAlgorithm(k, minconf, database);
			algo.printStats();
			algo.writeResultTofile(outputFile); // to save results to file
		} else if ("TNR".equals(algorithmName)) {
			com.lcc.algo.dm.algorithms.associationrules.TopKRules_and_TNR.Database database = new com.lcc.algo.dm.algorithms.associationrules.TopKRules_and_TNR.Database();
			database.loadFile(inputFile);
			...
			com.lcc.algo.dm.algorithms.associationrules.TopKRules_and_TNR.AlgoTNR algo = new com.lcc.algo.dm.algorithms.associationrules.TopKRules_and_TNR.AlgoTNR();
			algo.runAlgorithm(k, minconf, database, delta);
			algo.printStats();
			algo.writeResultTofile(outputFile); // to save results to file
		} else if ("TNS".equals(algorithmName)) {
			// Load database into memory
			com.lcc.algo.dm.input.sequence_database_array_integers.SequenceDatabase database = new com.lcc.algo.dm.input.sequence_database_array_integers.SequenceDatabase();
			database.loadFile(inputFile);
			...
			double minsup = getParamAsDouble(parameters[0]);
			com.lcc.algo.dm.algorithms.frequentpatterns.fpgrowth_with_strings.AlgoFPGrowth_Strings algo = new com.lcc.algo.dm.algorithms.frequentpatterns.fpgrowth_with_strings.AlgoFPGrowth_Strings();
			algo.runAlgorithm(inputFile, outputFile, minsup);
			algo.printStats();
			...
			com.lcc.algo.dm.patterns.itemset_array_integers_with_count.Itemsets patterns = apriori
			...
			com.lcc.algo.dm.algorithms.associationrules.agrawal94_association_rules.AlgoAgrawalFaster94 algoAgrawal = new com.lcc.algo.dm.algorithms.associationrules.agrawal94_association_rules.AlgoAgrawalFaster94();
			...
			com.lcc.algo.dm.patterns.itemset_array_integers_with_tids_bitset.Itemsets patterns = algo
			...
			com.lcc.algo.dm.algorithms.frequentpatterns.fpgrowth.AlgoFPGrowth fpgrowth = new com.lcc.algo.dm.algorithms.frequentpatterns.fpgrowth.AlgoFPGrowth();
			com.lcc.algo.dm.patterns.itemset_array_integers_with_count.Itemsets patterns = fpgrowth
			...
			com.lcc.algo.dm.patterns.itemset_array_integers_with_count.Itemsets patterns = cfpgrowth
		...
		// algo.printStats();
			...
			com.lcc.algo.dm.algorithms.frequentpatterns.apriori.AlgoApriori apriori = new com.lcc.algo.dm.algorithms.frequentpatterns.apriori.AlgoApriori();
			...
			com.lcc.algo.dm.algorithms.frequentpatterns.uapriori.UncertainTransactionDatabase context = new com.lcc.algo.dm.algorithms.frequentpatterns.uapriori.UncertainTransactionDatabase();
			...
			com.lcc.algo.dm.algorithms.frequentpatterns.two_phase.UtilityTransactionDatabaseTP database = new com.lcc.algo.dm.algorithms.frequentpatterns.two_phase.UtilityTransactionDatabaseTP();
			database.loadFile(inputFile);

			// Applying the Two-Phase algorithm
			AlgoTwoPhase twoPhase = new AlgoTwoPhase();
			com.lcc.algo.dm.algorithms.frequentpatterns.two_phase.ItemsetsTP highUtilityItemsets = twoPhase
			...
			com.lcc.algo.dm.algorithms.frequentpatterns.two_phase.ItemsetsTP highUtilityItemsets = algo
					.runAlgorithm(database, minutil);
