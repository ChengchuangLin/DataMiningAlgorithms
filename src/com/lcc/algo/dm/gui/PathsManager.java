...
class PathsManager {   
    ...
    public static final String REGKEY_SPMF_INPUT_FILE = "com.lcc.algo.dm.gui.input";
    public static final String REGKEY_SPMF_OUTPUT_FILE = "com.lcc.algo.dm.gui.output";
