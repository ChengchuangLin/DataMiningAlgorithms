package com.lcc.algo.dm.algorithms.frequentpatterns.apriori;
...
import com.lcc.algo.dm.algorithms.ArraysAlgos;
import com.lcc.algo.dm.patterns.itemset_array_integers_with_count.Itemset;
...
//                         System.out.println("test");
    ...
    public static void main(String[] args) {
        double minsup = 0.01;
        String input = "c:\\fim\\part-0000020141201";
        String output = "c:\\fim\\part-0000020141201_result_"+minsup;
        AlgoApriori algoApriori = new AlgoApriori();
        long sTime = new Date().getTime();
        System.out.println(sTime);
        try {
            algoApriori.runAlgorithm(minsup, input, output);
        } catch (IOException e) {
            e.printStackTrace();
        }
        long eTime = new Date().getTime();
        System.out.println((eTime-sTime)/1000+"s");
     }
}
