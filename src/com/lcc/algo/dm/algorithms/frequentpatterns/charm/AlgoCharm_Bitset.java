package com.lcc.algo.dm.algorithms.frequentpatterns.charm;
...
import com.lcc.algo.dm.datastructures.triangularmatrix.TriangularMatrix;
...
loopJ:		for(int j=i+1; j < frequentItems.size(); j++) {
	...
	void save(int[] prefix, int[] suffix, BitSetSupport tidset) throws IOException {
		...
		com.lcc.algo.dm.patterns.itemset_array_integers_with_count.Itemset itemset = new com.lcc.algo.dm.patterns.itemset_array_integers_with_count.Itemset(prefixSuffix);
